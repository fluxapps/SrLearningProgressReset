...
```php
\srag\DIC\SrLearningProgressReset\x\DICStatic::dic()->database()->createAutoIncrement(\srag\Plugins\x\x\x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\SrLearningProgressReset\x\DevTools\DevToolsCtrl;
...
    /**
     * @inheritDoc
     */
...
/**
 * ...
 * @ilCtrl_isCalledBy srag\DIC\SrLearningProgressReset\x\DevTools\DevToolsCtrl: ilXConfigGUI
 */
class ...
...
    /**
