...
```php
//...
use srag\RemovePluginDataConfirm\SrLearningProgressReset\x\PluginUninstallTrait;
//...
...
```php
//...
use srag\RemovePluginDataConfirm\SrLearningProgressReset\x\RepositoryObjectPluginUninstallTrait;
//...
