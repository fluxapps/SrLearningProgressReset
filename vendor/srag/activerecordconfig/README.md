...
```php
...
use srag\ActiveRecordConfig\SrLearningProgressReset\x\Config\AbstractFactory;
use srag\ActiveRecordConfig\SrLearningProgressReset\x\Config\AbstractRepository;
...
